...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180626014740_FirstMigration')
BEGIN
    CREATE TABLE [Alumno] (
...
BEGIN
    ...
    VALUES (N'20180626014740_FirstMigration', N'2.0.3-rtm-10026');
END;
